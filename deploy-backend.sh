...
echo "🌐 Backend API should be available at: http://modulus-backend-1734346092.eu-west-2.elb.amazonaws.com/api"

# Test the deployment
echo "🧪 Testing deployment..."
sleep 10

if curl -f -s "http://modulus-backend-1734346092.eu-west-2.elb.amazonaws.com/api/health" > /dev/null; then
