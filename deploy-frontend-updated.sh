...
IMAGE_NAME="modulus-frontend"
CLUSTER_NAME="modulus-cluster"
SERVICE_NAME="modulus-frontend"
...
echo "🌐 Frontend should be available at: http://modulus-backend-1734346092.us-east-1.elb.amazonaws.com"

# Test the deployment
echo "🧪 Testing deployment..."
sleep 10

if curl -f -s "http://modulus-backend-1734346092.us-east-1.elb.amazonaws.com" > /dev/null; then
